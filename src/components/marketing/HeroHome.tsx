...
const stats = [
  { value: '12–20%', label: 'Jahresrendite' },
  { value: '50+', label: 'Partner-Banken' },
  { value: '20+', label: 'Länder' },
  { value: '100%', label: 'Staatl. garantiert' },
];
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full text-sm font-semibold mb-6"
              ...
              Bis zu 20% Jahresrendite garantiert
            </div>
            ...
            >
              ...
              <br />
              <span style={{ color: 'var(--color-primary)' }}>weltweit, sicher, automatisch.</span>
            </h1>

            <p className="text-lg mb-8 max-w-lg" style={{ color: 'var(--color-text-secondary)' }}>
              Rentiers bündelt Bankeinlagen aus über 50 Ländern und liefert Ihnen 12–20%
              Jahresrendite mit staatlichen Einlagengarantien. Einfach, transparent, ohne Aktienrisiko.
            </p>
            ...
            {/* Trust line */}
            <p className="text-xs" style={{ color: 'var(--color-text-muted, #9CA3AF)' }}>
              🔒 Staatliche Einlagengarantien &nbsp;·&nbsp; Keine Mindestlaufzeit-Strafe &nbsp;·&nbsp; MSB-lizenziert
            </p>
          </div>

          {/* Right — App mockup + calculator card */}
          <div
            ...
            <div className="relative">
              ...
              >
                ...
                <div className="bg-white border-t flex justify-around px-2 py-2"
                     style={{ borderColor: 'var(--color-border)' }}>
                  {['🏠 Home', '📊 Portfolio', '🚀 Produkte', '🏦 Banken', '☰ Menu'].map((item, i) => (
                    <span key={i} className={`text-xs flex flex-col items-center gap-0.5 ${i === 0 ? 'font-semibold' : ''}`}
                          style={{ color: i === 0 ? 'var(--color-primary)' : 'var(--color-text-secondary)', fontSize: '9px' }}>
                      {item}
                    </span>
                  ))}
                </div>
              ...
              >
                ...
                <div className="space-y-2">
                  <div className="rounded-lg p-2" style={{ background: 'var(--color-bg-light)' }}>
                    ...
                    <p className="text-xs" style={{ color: 'var(--color-text-secondary)' }}>jeden Monat auf Ihre Karte</p>
                  </div>
                  <div className="rounded-lg p-2" style={{ background: 'var(--color-bg-light)' }}>
